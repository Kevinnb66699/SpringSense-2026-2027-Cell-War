...
func _ready() -> void:
	...
	%BtnMcImmune.pressed.connect(_pick.bind(4, "mc", CWData.FACTION_IMMUNE))
	%BtnMcWatchImmune.pressed.connect(_pick.bind(4, "mc_watch_immune", ""))
	%BtnMcWatchCancer.pressed.connect(_pick.bind(4, "mc_watch_cancer", ""))
